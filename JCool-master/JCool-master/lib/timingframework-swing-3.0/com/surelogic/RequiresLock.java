 ...
 * annotation are <i>not</i> required to maintain that holding the referenced
 * set of locks is a precondition to their invocation (the set of required locks
 * is contravariant), but may via explicit annotation.
 * 
 * <h3>Semantics:</h3>
 * 
 * Constrains code that invokes an annotated method or constructor to hold each
 * of the lock objects declared in the {@link RegionLock} declarations for the
 * set of named locks referred to by the annotation.
 * 
 * <h3>Examples:</h3>
 * 
